---
title: "Suicide Rates Overview Dashboard"
...
data <- read.csv('suicide-rates.csv') %>%
  filter(year != 2016, # filter out 2016 and countries with 0 data
         country != 'Dominica',
         country != 'Saint Kitts and Nevis')
         
# Fix the names of some of the countries in data to match the country names 
...
div(style = "position: absolute; bottom: 0; right: 0; font-size: 12px; padding-right: 10px;",
